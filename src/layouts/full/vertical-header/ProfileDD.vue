    ...
    <v-sheet rounded="md" width="280" elevation="10">
      <div class="pa-6">
        <div class="d-flex align-center pb-6">
          ...
          <div class="ml-3">
            <h6 class="text-subtitle-1">John Doe <span class="text-success text-caption">Pro</span></h6>
            <span class="text-subtitle-1 textSecondary">test@test.com</span>
          </div>
        </div>
        <v-divider></v-divider>
        <perfect-scrollbar>
          <v-list class="py-0 theme-list mt-3" :class="{ cairo: $i18n.locale == 'ro' }" lines="one">
            <v-list-item
