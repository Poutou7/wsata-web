...
<template>
            ...
            <div>
                <v-row>
                    ...
                    <v-col cols="12" md="4" class="pa-0">
                        <img src="@/assets/images/backgrounds/mega-dd-bg.jpg" alt="Our Theme-img" height="320" class="w-100" />
                    </v-col>
                </v-row>
            </div>
        </v-sheet>
    ...
    <v-btn
        ...
        >Documentation</v-btn
    >
    <v-btn variant="text" class="custom-hover-primary font-weight-medium nav-links" href="https://Our Theme.com" target="_blank"
        >Support</v-btn
    >
    <v-btn class="custom-hover-primary bg-primary ml-2 text-white px-6" flat href="/auth/login" target="_blank"
