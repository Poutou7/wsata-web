...
const barChart = {
  series: [
    {
      name: 'settlements',
      data: [40, 40, 80, 80, 30, 30, 60, 60, 20]
    }
  ]
};
</script>
    ...
    <v-card-item>
      <div class="d-flex gap-3 align-center">
        ...
        <div>
          ...
          <h3 class="text-h3 heading font-weight-bold">122,580 SR</h3>
        </div>
      </div>
      ...
      <div>
        <div class="d-flex justify-space-evenly gap-4">
          <div class="pe-8 text-center">
            <p class="textPrimary mb-1">Total Settled</p>
            <h3 class="text-h3 heading">122,580 SR</h3>
          </div>
          <div class="ps-8 text-center">
            <p class="textPrimary mb-1">Waiting Settlement</p>
            <h3 class="text-h3 heading">31,640 SR</h3>
          </div>
        </div>
      </div>
    </v-card-item>
