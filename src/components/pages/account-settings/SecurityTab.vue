                    ...
                    <v-card-item>
                        ...
                        <div class="d-sm-flex justify-space-between mt-4 mb-8">
                            <div class="text-subtitle-1 textSecondary text-13 pr-5">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis sapiente sunt earum
                                officiis laboriosam
                                ut.
                            </div>
                        ...
                        <div class="mt-sm-8 mt-5">
                            ...
                            <div class="d-flex gap-3 align-center my-4">
                                ...
                                <div class="">
                                    ...
                                    <p class="text-body-1 textSecondary">Saudi Arabia, Oct 24 at 3:15 AM</p>
                                </div>
                                <v-btn size="30" icon variant="flat" class="lightprimary ms-auto">
                                    <v-avatar size="20">
                                        <DotsVerticalIcon />
